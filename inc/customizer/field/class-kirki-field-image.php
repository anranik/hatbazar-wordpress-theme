...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'hatbazar' ),
				'change'       => esc_attr__( 'Change image', 'hatbazar' ),
				'default'      => esc_attr__( 'Default', 'hatbazar' ),
				'remove'       => esc_attr__( 'Remove', 'hatbazar' ),
				'placeholder'  => esc_attr__( 'No image selected', 'hatbazar' ),
				'frame_title'  => esc_attr__( 'Select image', 'hatbazar' ),
				'frame_button' => esc_attr__( 'Choose image', 'hatbazar' ),
			)
		);
	}
