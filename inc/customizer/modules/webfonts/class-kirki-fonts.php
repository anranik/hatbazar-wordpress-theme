...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'hatbazar' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'hatbazar' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'hatbazar' ),
			'200'       => esc_attr__( 'Light 200', 'hatbazar' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'hatbazar' ),
			'300'       => esc_attr__( 'Book 300', 'hatbazar' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'hatbazar' ),
			'400'       => esc_attr__( 'Normal 400', 'hatbazar' ),
			'regular'   => esc_attr__( 'Normal 400', 'hatbazar' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'hatbazar' ),
			'500'       => esc_attr__( 'Medium 500', 'hatbazar' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'hatbazar' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'hatbazar' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'hatbazar' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'hatbazar' ),
			'700'       => esc_attr__( 'Bold 700', 'hatbazar' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'hatbazar' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'hatbazar' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'hatbazar' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'hatbazar' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'hatbazar' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'hatbazar' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'hatbazar' ),
		);
	}
