...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'hatbazar' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'hatbazar' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'hatbazar' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'hatbazar' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'hatbazar' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'hatbazar' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'hatbazar' ); ?>',
		} );
		#>
		<label>
