	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'hatbazar' ),
				'remove'               => esc_attr__( 'Remove', 'hatbazar' ),
				'default'              => esc_attr__( 'Default', 'hatbazar' ),
				'selectFile'           => esc_attr__( 'Select File', 'hatbazar' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'hatbazar' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'hatbazar' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'hatbazar' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'hatbazar' ),
			)
		);
